...
#transform.plot()
plt.plot(*transform.transform(sampleBeginning=1, sampleEnd=2, frequency_beginning = 0, frequency_end =  500))
...
plt.show()
plt.plot(*translator.transform(sampleBeginning=1, sampleEnd=2, frequency_beginning = 0, frequency_end =  500))
