...
#transform.plot()
plt.plot(*transform.transform(sampleBeginning=1, sampleEnd=2, frequencyBeginning = 0, frequencyEnd =  500))
...
plt.show()
plt.plot(*translator.transform(sampleBeginning=1, sampleEnd=2, frequencyBeginning = 0, frequencyEnd =  500))
